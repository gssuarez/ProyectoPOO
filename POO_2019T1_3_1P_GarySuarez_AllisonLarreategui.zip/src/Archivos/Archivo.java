...
public class Archivo {
    ...
    public final static String direccionCliente = "src/Archivos/cliente.txt";
    ...
    public final static String direccionReserva = "src/Archivos/reservas.txt";
    public final static String direccionBoleto = "src/Archivos/boletos.txt";
    ...
    public static ArrayList<String> reservas = Archivo.leerArchivo(direccionReserva);
    public static ArrayList<String> boletos = Archivo.leerArchivo(direccionBoleto);
